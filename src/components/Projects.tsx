    ...
    return (
        <div className="rounded-lg bg-card text-card-foreground flex flex-col overflow-hidden border hover:shadow-xl transition-all duration-300 ease-out h-full">
            ...
            <div className=" flex flex-wrap gap-x-3 px-2 pt-2 text-sm mt-auto text-pretty">
                {
                    item.techs.map((tech) => (
                        <div className="inline-flex items-center rounded-md transition-all text-[10px] font-semibold text-black  transition-all duration-300 dark:text-white">
                            {tech}
                        </div>
                    ))
                }
            ...
            <div className="flex flex-row flex-wrap items-start gap-2 p-2">
                ...
                <a target="_blank" href={item.git}>
                    <div className="items-center rounded-md border font-semibold transition-all border-transparent bg-black  transition-all duration-300 dark:bg-neutral-200 text-white  transition-all duration-300 dark:text-black shadow hover:bg-black/90 flex gap-2 px-2 py-1 text-[10px]">

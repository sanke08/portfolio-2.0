            ...
            <div className="w-full space-y-8">
                <div className="flex flex-col items-center space-y-4 text-center">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground xl:text-lg w-[90%]">
    ...
    return (
        <div className="rounded-lg bg-card text-card-foreground flex flex-col overflow-hidden border hover:shadow-xl transition-all duration-300 ease-out h-full">
            <div className="space-y-1  px-2">
                <h3 className="font-semibold mt-1 text-base  transition-all duration-300 dark:text-white text-neutral-700">
                    {item.name}
                </h3>
                <div className=" max-w-full text-pretty text-xs text-neutral-600  transition-all duration-300 dark:text-neutral-400 font-medium" >
                    {
                        item.desc
                    }
                </div>
            </div>
            <div className=" flex flex-wrap gap-x-3 px-2 pt-2 text-sm mt-auto text-pretty">
                {
                    item.techs.map((tech) => (
                        <div className="inline-flex items-center rounded-md  text-[10px] font-semibold text-black  transition-all duration-300 dark:text-white">
                            {tech}
                        </div>
                    ))
                }
            ...
            <div className="flex flex-row flex-wrap items-start gap-2 p-2">
                {
                    ...
                    <a target="_blank" href={item.live}>
                        <div className={`items-center rounded-md border font-semibold transition-all border-transparent bg-black text-white shadow hover:bg-black/90 flex gap-2 px-2 py-1 text-[10px] ${(item.git && item.live) ? " border border-white/40" : "dark:bg-white bg-black text-white dark:text-black"} `}>
                            <svg
                ...
                }
                {
                    ...
                    <a target="_blank" href={item.git}>
                        <div className="items-center rounded-md border font-semibold border-transparent bg-black  dark:bg-neutral-200 text-white  transition-all duration-300 dark:text-black shadow hover:bg-black/90 flex gap-2 px-2 py-1 text-[10px]">

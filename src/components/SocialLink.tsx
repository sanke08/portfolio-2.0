...
const SocialLink = ({ linkRef }:{linkRef:LegacyRef<HTMLDivElement>}) => {
    return (
        <div ref={linkRef} className=" opacity-0 transition-all duration-500 delay-1000 ease-out transform w-max -translate-y-1/4 items-center border-2 grid grid-cols-3 px-6 py-3 gap-2 sm:gap-6 rounded-lg">
